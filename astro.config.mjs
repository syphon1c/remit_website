		...
		starlight({
			...
			sidebar: [
				{ label: 'Start here', items: [
					...
					{ label: 'Coworker teams', slug: 'docs/coworker/teams' },
				] },
				{ label: 'Remit Coworker', items: [
					...
					{ label: 'The Grapevine', slug: 'docs/coworker/grapevine' },
					{ label: 'Trying the Grapevine', slug: 'docs/coworker/grapevine-trying' },
