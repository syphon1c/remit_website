...
[README.md](/docs/cloud/overview/); the mechanics of review are in
docs/sharing.md.
...
Signed in, the **Coworker Gallery** appears in their account menu, headed with your
organisation's name. Installing copies your
...
- **Who can see it** — in the default `none` auth mode, anyone who can reach the
  ...
  let your identity provider decide (docs/auth.md).
